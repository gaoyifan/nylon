...
- **Single Binary, Single Data Port**: One statically-linked binary, one WireGuard UDP port (`57175`), one YAML config. Optional Linux LAN discovery uses UDP `57176` for signed, subnet-local broadcast announcements.
